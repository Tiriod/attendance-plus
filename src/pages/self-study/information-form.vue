<template>
    <view class="box-card">
        ...
        <information-entry icon_url="./static/icon/icon_sun.png" module_text="早晚自习" open_selector
                           :options="['早自习', '晚自习']"/>
...
<script>
import InformationEntry from "./information-entry.vue";

export default {
    name: "self-study-information-form",
    components: {InformationEntry},
    data() {
        const time = new Date();
        return {
            attendance_week_times: time,
            attendance_week_day: time.getDay(),
